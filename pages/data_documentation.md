...
* **Documentation in a web submission form of the deposition database or repository.** In some cases, repositories and archives have specific [metadata fields](metadata.html) in their web submission form, which could require a specific [ontology](ontology.html) or controlled vocabulary. Find out the fields of the submission form of the repository to which you are planning to submit your data, copy these fields into your data documentation and fill these in as you go through your project.
* **Documentation in a separate structured metadata file.** Some disciplines have developed structured [metadata schemas](metadata.html) for recording supporting information. Find out the fields of the metadata schema, download or copy these fields into your data documentation and fill these in as you go through your project. A structured metadata file can accompany files/data being deposited in a repository.
